...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#E696C0", "#d94191", "#9ccc65"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffba57", "#ff5252", "#E696C0"]
        });
        ...
        Morris.Area({
            ...
            pointSize: 0,
            fillOpacity: 0.8,
            pointStrokeColors: ['#b4becb', '#d94191'],
            behaveLikeLine: true,
        ...
        Morris.Area({
            ...
            lineColors: ['#9ccc65', '#d94191', '#E696C0'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffba57', '#ff5252', '#E696C0'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffba57', '#ff5252', '#E696C0'],
            lineWidth: 2,
            hideHover: true
        });
